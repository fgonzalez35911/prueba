...
<head>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            .messages-display {
                padding-bottom: 70px; /* Ajustar este valor según la altura de la barra de input */
            }
            ...
            <div class="message-input-area">
                <form id="chat-form" action="chat_enviar.php" method="POST">
                    ...
                    <div class="input-group">
                        <textarea class="form-control flex-grow-1" id="message-content" name="contenido" rows="1" placeholder="Escribe un mensaje..." required oninput="this.style.height='auto'; this.style.height=(this.scrollHeight)+'px';"></textarea>
...
<?php if ($mostrar_chat_activo): ?>
    <script>
        ...
        function setFullHeight() {
            ...
            if (chatContainer) {
                 // Aplica la altura calculada al contenedor principal del chat.
